            ...
            <form action="{{ url('/admin/update_blog/' . $data->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="subtitle" class="form-control" required value="{{ $data->subtitle }}" placeholder="subtitle...">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" name="text" class="form-control" required placeholder="Text...">{{ $data->text }}</textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="link" class="form-control" required value="{{ $data->link }}" placeholder="https://example.com">
                    </div>
