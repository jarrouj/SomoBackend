                            ...
                            <div class="d-flex justify-content-center">
                                <form action="/admin/blog" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input {{$show->blog_sh == 1 ? 'bg-success' : 'bg-danger' }}" type="checkbox" role="switch" id="flexSwitchCheckDefault"
                                        onchange="this.form.submit()" value="{{ $show->blog_sh == 1 ? '0' : '1' }}" name="datash" {{$show->blog_sh == 1 ? 'checked' : ''}}>
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        @forelse ($blog as $data)
                                            <tr class="text-center">
                                                <td >
                                                        <img src="/blog/{{ $data->img }}" async class="d-block m-auto" width="50px" alt="">
                                                ...
                                                <td>
                                                    <a class="text-xs font-weight-bold mb-0 text-primary" href="{{ $data->link }}" target="_blank">
                                                        {{ $data->link }}
                                                    </a>
                                                </td>
