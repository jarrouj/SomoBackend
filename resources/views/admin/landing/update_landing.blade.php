            ...
            <form action="{{ url('/admin/update_landing/' . $data->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control"  value="{{ $data->title }}" placeholder="Hero Title...">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" name="text" class="form-control" required placeholder="Hero Text...">{{ $data->text }}</textarea>
                    </div>
